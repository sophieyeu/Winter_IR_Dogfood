...
public class DogfoodXMLReader extends XMLMatchableReader<Dogfood, Attribute> {
...
//            List<String> stopwords = new ArrayList<String>();
    ...
    @Override
    public Dogfood createModelFromElement(Node node, String provenanceInfo) {

        // create the object with id and provenance information
        Dogfood food = new Dogfood(getValueFromChildElement(node, "productid"), provenanceInfo);
